...
switch ($action) {
	...
	$phonenumber = _post('phonenumber');
        ...
        $msg = '';
        if(Validator::Length($username,10,0) == false){
            $msg .= 'Username Minimal 1 Karakter'. '<br>';
        }
        if(Validator::Length($fullname,20,0) == false){
            $msg .= 'Full Name Minimal 1 Karakter'. '<br>';
        }
        if(!Validator::Length($password,10,0)){
            $msg .= 'Password Minimal 1 Karakter'. '<br>';
	...
	$phonenumber = _post('phonenumber');
        ...
        if(Validator::Length($fullname,20,0) == false){
            $msg .= 'Full Minimal 1 Karakter'. '<br>';
        }
        if($password != ''){
            if(!Validator::Length($password,10,0)){
                $msg .= 'Password Minimal 1 Karakter'. '<br>';
